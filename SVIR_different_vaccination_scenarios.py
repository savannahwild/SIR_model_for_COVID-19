# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 07:08:56 2021

@author: savan
"""
#key results daily cases and deaths
...
#add 4 subplots to figure
ax1 = fig1.add_subplot(2,1,1)
ax2 = fig1.add_subplot(2,1,2)

#for loop to plot for each take up value
for scenario in scenarios:    
    
    # vaccine calculator calculates frac_vac, risks, initial conditions
    #S0, V0, Is0, and Iv0
    ...
    C_obs  = Cs_obs + Cv_obs
    #plot daily cases
    ax2.plot(t_obs,C_obs, label=str(scenario))
    ...
    D_obs  = Ds_obs + Dv_obs
    #plot daily deaths
    ax1.plot(t_obs,D_obs, label=str(scenario))
    
#format deaths plot
ax1.legend(title='Scenario:')
ax1.set_title('Daily deaths over time, for varying vaccination scenarios')
ax1.set_xlabel('time (days)')
ax1.set_ylabel('Number of deaths')
ax1.set_xlim(1,400)
#format cases plot
ax2.legend(title='Scenario:')
ax2.set_title('Daily cases over time, for varying vaccination scenarios')
